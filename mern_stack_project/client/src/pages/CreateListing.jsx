...
export default function CreateListing() {
    ...
    const [rentOrSell, setRentOrSell] = useState(false)
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input onChange={handleChange} value={formData.description} type="text" placeholder='Description' className='border p-3 rounded-lg' id='description' maxLength='500' minLength='10' required/>
            ...
            <div className='flex flex-wrap gap-6'>
                <div className='flex items-center gap-2'>
                    <input onChange={handleChange} checked={formData.bedrooms} type="number" id='bedrooms' min='1' max='10' required className='p-3 border-gray-300 rounded-lg'/>
                    <p>Beds</p>
                </div>
                <div className='flex items-center gap-2'>
                    <input onChange={handleChange} checked={formData.bathrooms} type="number" id='bathrooms' min='1' max='10' required className='p-3 border-gray-300 rounded-lg'/>
                    <p>Bath</p>
                </div>
                <div className='flex items-center gap-2'>
                    <input onChange={handleChange} checked={formData.regularPrice} type="number" id='regularPrice' min='50' max='100000000' required className='p-3 border-gray-300 rounded-lg'/>
            ...
            {formData.offer && (
            <div className='flex items-center gap-2'>
                <input onChange={handleChange} checked={formData.discountPrice} type="number" id='discountPrice' min='50' max='100000000' required className='p-3 border-gray-300 rounded-lg'/>
                <div className='flex flex-col items-center'>
                <p>Discount Price</p>
                <span className='text-xs'>($ / month)</span>
                </div>
